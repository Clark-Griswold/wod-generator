...
function getWeather(){
  ...
  if(city != '') {
    $.ajax({
      url: 'https://api.openweathermap.org/data/2.5/weather?q=' + city + '&units=imperial' + '&APPID=d797fca7dbd2e114fdd66309da5fc73d',
      type: "GET",
      datatype: "jsonp",
...
function showResults(data) {
  return  '<h2 style="font-weight:bold; font-size:30px; padding-bottom:20px" class="text-center">Current weather for '+data.name+', '+data.sys.country+'</h2>'+
          ...
          "<h3 style='padding-left:40px; padding-bottom:30px'><strong>Wind</strong>: "+data.wind.speed+" miles/hour</h3>";
